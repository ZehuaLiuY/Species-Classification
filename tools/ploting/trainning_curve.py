...
ax1.plot(train_x_values, train_y_values, linestyle='-', color='#8768a6', label='Train Accuracy')
ax1.plot(val_x_values, val_y_values, linestyle='-', color='#6dc2dc', label='Validation Accuracy')
...
ax2.spines['top'].set_visible(False)     # 隐藏上边框（可选）
...
# plt.savefig('scheduler_loss_curve.pdf', dpi=600, bbox_inches='tight', pad_inches=0.1)
